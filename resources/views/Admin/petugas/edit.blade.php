    ...
    <div class="card-body">
        ...
        <form action="{{route('admin.petugas.store')}}" method="POST" id="myForm">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama" name="nama" autocomplete="off" value="{{$petugas->nama}}"/>
                @error('nama')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="username" name="username" autocomplete="off" value="{{$petugas->username}}"/>
                @error('username')
                    <div class="text-danger">
                        {{ $message }}
                    </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control phone-mask" name="telp" value="{{$petugas->telp}}"/>
                    @error('telp')
                    <div class="text-danger">
                        {{ $message }}
                    </div>
