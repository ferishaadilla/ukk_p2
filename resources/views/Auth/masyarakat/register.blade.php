                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{route('register')}}" method="POST" class="row g-3">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="number" name="nik" class="form-control @error('nik') is-invalid @enderror" id="yourName" required>
                                            @error('nik')
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" id="yourName" required>
                                            @error('nama')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                <input type="number" name="telp" class="form-control @error('telp') is-invalid @enderror" required>
                                                @error('telp')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
